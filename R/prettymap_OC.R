library(colorspace)
## ===========pretty t-SNE===========
prettyMap_OC <- function(map_matrix, object, 
                      fcol = "markers",
                       main = "", 
                       mainCol = (setStockcol(cols_oc)), 
                       outlineCol = darken(setStockcol()), 
                       pchUn = 21, lwd = 1,
                       ...) {
...
prettyMap_overlay_OC <- function(map_matrix, object, fcol = "markers",
                               main = "", 
